...
var wallSquares = [3, 8, 10, 12, 15, 19, 22, 24, 25, 26, 29, 33, 38];
//
...
Blockly.JavaScript['driveRobot'] = function(block) {
	...
	if (currentLocation == goalSquare) {
		code += "document.getElementById('s" + goalSquare + "').style.backgroundImage='url(images/win.png)';";
		victorySound.play();
		window.alert("You Won!");
	}
	else{
		code += "document.getElementById('s" + goalSquare + "').style.backgroundImage='url(images/goal.png)';";
	}
	return code;
